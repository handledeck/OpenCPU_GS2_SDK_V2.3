...
enum {
    ...
    Ql_RET_ERR_MEM_FULL                         = -81, // 201206003 Ramos add for Ql_WDTMF api
    QL_ERR_DTMFSTRING_TOO_LONG                  = -82, // 201206003 Ramos add for Ql_WDTMF api
    QL_ERR_WDTMF_PS_BUSY                        = -83, // 201206003 Ramos add for Ql_WDTMF api
    QL_ERR_DTMF_BUSY                            = -84,
    ...
    Ql_RET_ERR_EINT_USED                       =-300, //20120530 Ramos add for EINT conflict

    /* SMS -500 ~ -550*/  /*Laguna.xu  2012-6-19*/
    ...
    /* Flash OPT Begin */      //max.tang@2012Äê6ÔÂ7ÈÕ 17:05:37 add for the result of flash option in fota function!           
    //Don't Change any value below!!!!!!
     Ql_RET_ERR_RAWFLASH_OVERRANGE                = -8001,    //out of specified range
     ...
     Ql_RET_ERR_RAWFLASH_MAXLENGATH               = -8009,    //more than max length
     /* Flash OPT End */
    
    Ql_RET_ERR_OPERATE_NEEDWAIT = -9997,
