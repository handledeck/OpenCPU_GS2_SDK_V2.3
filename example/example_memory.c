...
*   Description:
*
*           This example gives an example for MEMORY operation.
*           Through Uart port, input the special command, there will be given the response about memory operation.
*
*   Usage:
*
*           Precondition:
*
*                   Use "make/make128 memory" to compile, and download bin image to module.
*           
*           Through Uart port:
*
